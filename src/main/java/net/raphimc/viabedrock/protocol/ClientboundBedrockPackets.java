...
public enum ClientboundBedrockPackets implements ClientboundPacketType {
    ...
    // MOT leftover IDs omitted from generated MinecraftPacketIds. Unknown IDs abort the RakNet batch.
    TICK_SYNC(MinecraftPacketIds.TickSync.getValue()),
    LEVEL_SOUND_EVENT_V1(MinecraftPacketIds.LevelSoundEventV1.getValue()),
    ENTITY_FALL(MinecraftPacketIds.EntityFall.getValue()),
    CRAFTING_EVENT(MinecraftPacketIds.CraftingEvent.getValue()),
    ADVENTURE_SETTINGS(MinecraftPacketIds.AdventureSettings.getValue()),
    ITEM_FRAME_DROP_ITEM(MinecraftPacketIds.ItemFrameDropItem.getValue()),
    ...
    VIDEO_STREAM_CONNECT(MinecraftPacketIds.VideoStreamConnect.getValue()),
    SCRIPT_CUSTOM_EVENT(MinecraftPacketIds.ScriptCustomEvent.getValue()),
    UPDATE_BLOCK_PROPERTIES(MinecraftPacketIds.UpdateBlockProperties.getValue()),
